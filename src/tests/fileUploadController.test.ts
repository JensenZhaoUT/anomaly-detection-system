...
import * as anomalyModel from "../models/anomalyModel"; // Import anomalyModel
...
describe("File Upload Controller", () => {
  ...
  it("should save anomalies with frames", async () => {
    const anomalies = [
      {
        ...
        frame: "frame_1.png",
        frameData: "data:image/png;base64,frameData1",
      },
      {
        ...
        frame: "frame_2.png",
        frameData: "data:image/png;base64,frameData2",
      },
    ];
    ...
    (path.join as jest.Mock)
      .mockReturnValueOnce("/images/frame_1.png")
      .mockReturnValueOnce("/images/frame_2.png");
    (fs.writeFileSync as jest.Mock).mockImplementation(() => {});
