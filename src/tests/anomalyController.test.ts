...
describe('Anomaly Controller', () => {
  ...
  it('should fetch all anomalies', async () => {
    ...
    (anomalyModel.getAnomalies as jest.Mock).mockResolvedValue(Promise.resolve(mockAnomalies));
  ...
  it('should create a new anomaly', async () => {
    ...
    (anomalyModel.createAnomaly as jest.Mock).mockResolvedValue(Promise.resolve(savedAnomaly));
  ...
  it('should fetch an anomaly by id', async () => {
    ...
    (anomalyModel.getAnomalyById as jest.Mock).mockResolvedValue(Promise.resolve(mockAnomaly));
  ...
  it('should return 404 if anomaly not found', async () => {
    (anomalyModel.getAnomalyById as jest.Mock).mockResolvedValue(Promise.resolve(null));
  ...
  it('should save anomalies', async () => {
    ...
    (anomalyModel.createAnomaly as jest.Mock)
      .mockResolvedValueOnce(Promise.resolve(savedAnomalies[0]))
      .mockResolvedValueOnce(Promise.resolve(savedAnomalies[1]));
