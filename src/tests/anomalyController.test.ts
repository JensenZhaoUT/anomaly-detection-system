...
describe("Anomaly Controller", () => {
  ...
  it("should fetch all anomalies", async () => {
    ...
    (anomalyModel.getAnomalies as jest.Mock).mockResolvedValue(
      Promise.resolve(mockAnomalies)
    );
  ...
  it("should create a new anomaly", async () => {
    ...
    (anomalyModel.createAnomaly as jest.Mock).mockResolvedValue(
      Promise.resolve(savedAnomaly)
    );
  ...
  it("should fetch an anomaly by id", async () => {
    ...
    (anomalyModel.getAnomalyById as jest.Mock).mockResolvedValue(
      Promise.resolve(mockAnomaly)
    );
